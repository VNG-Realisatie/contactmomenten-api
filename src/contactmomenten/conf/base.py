...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "contactmomenten"),
        "USER": os.getenv("DB_USER", "contactmomenten"),
        "PASSWORD": os.getenv("DB_PASSWORD", "contactmomenten"),
...
ROOT_URLCONF = "contactmomenten.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "contactmomenten.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "contactmomenten.wsgi.application"
...
DEFAULT_FROM_EMAIL = "contactmomenten@example.com"
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "contactmomenten.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    "contactmomenten.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "contactmomenten_sessionid"

#
# Custom settings
#
PROJECT_NAME = "Contactmomenten"
SITE_TITLE = "Contactmomenten API"
...
NOTIFICATIONS_KANAAL = "contactmomenten"
